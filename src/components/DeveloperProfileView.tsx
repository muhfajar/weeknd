...
export const DeveloperProfileView: React.FC<DeveloperProfileViewProps> = ({
    ...
    return (
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 space-y-10">
            ...
            <div className="bg-[#141414] border border-[#262626] rounded-2xl p-6 md:p-8 space-y-6 shadow-xl relative overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 relative z-10">
                    <div className="flex items-start gap-4 sm:gap-5">
                        {developer.avatar ? (
                            ...
                            <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gradient-to-br from-red-500/20 to-zinc-800 border border-red-500/30 flex items-center justify-center text-red-400 font-mono font-bold text-xl sm:text-2xl flex-shrink-0 shadow-md">
                        ...
                        <div className="space-y-1.5">
                            <div className="flex items-center gap-2">
                                <span className="text-[10px] font-mono tracking-widest text-red-400 uppercase px-2 py-0.5 rounded-full bg-red-500/10 border border-red-500/20">
                                    Indie Builder
                                </span>
                            </div>
                ...
                {devApps.length > 0 ? (
                    ...
                    <div className="bg-[#141414] border border-[#262626] rounded-2xl p-12 text-center space-y-3">
                        ...
                        <p className="text-xs font-mono text-[#888888] max-w-md mx-auto">
                            This developer profile exists, but no apps on weeknd.dev have been tagged with this profile yet.
                        </p>
                    </div>
                )}
            </div>
