...
linkedin: https://www.linkedin.com/in/muhfajar/
github: https://github.com/muhfajar
---

### About

**Software Engineer** with **10+ years** of experience building scalable products across backend, platform, and developer tooling.

### Focus
- **Backend Engineering** — Go, Python, Ruby
- **Developer Experience** — APIs, tooling, system architecture
- **Product Development** — From idea to production
- **Indie Making** — Building software on weekends

### Currently
Building thoughtful products that blend **engineering**, **design**, and **craftsmanship**, while exploring open source and side projects.